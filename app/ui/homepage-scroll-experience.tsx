  ...
  return (
    <section>
      <div className="mx-auto max-w-5xl p-6 md:p-10">
        <div className="mb-8 font-black text-white text-4xl sm:text-5xl md:text-6xl">
...
//   return (
//     <div className="mb-2 text-center text-white text-4xl md:text-5xl font-black md:mb-4">
//       {children}
//     </div>
//   );
// }
...
function SayGoodbyeOutro() {
  ...
  return (
    <div
      aria-hidden
      className={
        `sticky top-0 flex h-screen w-screen items-center justify-center text-center font-black text-white text-4xl sm:text-5xl sm:leading-6xl md:text-7xl lg:text-8xl xl:text-9xl` +
        " " +
...
function SayGoodbye() {
  ...
  return (
    <div
      ...
      className={
        `flex h-screen w-screen items-center justify-center text-center font-black text-white text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl` +
        " " +
