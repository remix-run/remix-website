...
function RenderingUiPage(handle: Handle<DocsPageProps>) {
  return () => (
    ...
    >
      <DocsSection
        id="the-remix-component-model"
        title="The Remix component model"
      >
      ...
      >
        <p>
          Placeholder for Server rendering with renderToStream and
          renderToString.
        </p>
      </DocsSection>

      <DocsSection
        id="document-shells-and-head-content"
        title="Document shells and head content"
      >
      ...
      <DocsSection
        id="theme-tokens-and-createtheme"
        title="Theme tokens and createTheme"
      >
      ...
      >
        <p>
          Placeholder for First-party UI components: buttons, menus, popovers,
          listboxes, selects, comboboxes.
        </p>
      </DocsSection>
    </DocsChapter>
  );
