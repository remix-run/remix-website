...
export async function dataAndValidationHandler({
  render,
  request,
}: AppContext) {
  return render(
    <DataAndValidationPage requestUrl={request.url} />,
    docsResponseInit,
  );
}
...
function DataAndValidationPage(handle: Handle<DocsPageProps>) {
  return () => (
    ...
    >
      <DocsSection
        id="validating-trust-boundaries"
        title="Validating trust boundaries"
      >
      ...
      <DocsSection
        id="tables-with-remix-data-table"
        title="Tables with remix/data-table"
      >
        <p>Placeholder for Tables with remix/data-table.</p>
      </DocsSection>

      <DocsSection
        id="queries-and-crud-helpers"
        title="Queries and CRUD helpers"
      >
      ...
      <DocsSection
        id="request-scoped-database-access"
        title="Request-scoped database access"
      >
