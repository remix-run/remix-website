...
function ExampleAppsPage(handle: Handle<DocsPageProps>) {
  return () => (
    ...
    >
      ...
      <DocsSection
        id="frames-partial-server-ui"
        title="Frames: partial server UI"
      >
      ...
      >
        <p>
          Placeholder for Timeboxer: auth, CSRF, JSON endpoints, calendar
          export.
        </p>
      </DocsSection>
      ...
      >
        <p>
          Placeholder for UNPKG clone: tar parsing, file responses, package
          browsing.
        </p>
      </DocsSection>

      <DocsSection
        id="sse-streaming-server-events"
        title="SSE: streaming server events"
      >
