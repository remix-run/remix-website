...
function StartHerePage(handle: Handle<DocsPageProps>) {
  return () => (
    ...
    >
      ...
      >
        <p>
          Placeholder for Project tour: server.ts, app/routes.ts, app/router.ts,
      ...
      >
        <p>
          Placeholder for The core model: Request, middleware, router,
          controller, Response.
        </p>
      </DocsSection>
      ...
      <DocsSection
        id="build-your-first-form-action"
        title="Build your first form action"
      >
        <p>Placeholder for Build your first form action.</p>
      </DocsSection>

      <DocsSection
        id="add-your-first-hydrated-component"
        title="Add your first hydrated component"
      >
