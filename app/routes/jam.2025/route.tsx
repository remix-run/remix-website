...
function Nav() {
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-8">
        <div className="flex items-center gap-8">
          <img src={logoHref} alt="Remix Jam" className="h-8" />
          <img src={locationHref} alt="Toronto 2025" className="h-8" />
        </div>
        <Link
          to="#newsletter"
          className="rounded-full bg-black px-6 py-2 text-base font-medium text-white transition hover:bg-gray-800"
        >
          Tickets
        </Link>
      </div>
  ...
  return (
    <div className="mx-auto max-w-2xl text-center">
      ...
      <form className="flex flex-col gap-4">
        ...
        <button
          type="submit"
          className="mt-4 rounded-lg bg-black px-6 py-3 font-semibold text-white transition hover:bg-gray-900"
        >
          Sign Up
        </button>
      </form>
