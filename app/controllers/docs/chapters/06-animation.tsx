...
function AnimationPage(handle: Handle<DocsPageProps>) {
  return () => (
    ...
    >
      ...
      <DocsSection
        id="entrance-and-exit-animations"
        title="Entrance and exit animations"
      >
      ...
      <DocsSection
        id="springs-tweens-and-easing"
        title="Springs, tweens, and easing"
      >
        <p>Placeholder for Springs, tweens, and easing.</p>
      </DocsSection>

      <DocsSection
        id="interruptible-interactions"
        title="Interruptible interactions"
      >
