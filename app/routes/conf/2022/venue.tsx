...
function Title({ className }: { className: string }) {
  return (
    <div className={className}>
      <h1 className="mb-2 text-3xl font-extrabold sm:text-5xl xl:text-7xl">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="w-full text-center">
              <a
                ...
                className={`${primaryButtonLinkClass} font-extrabold uppercase lg:w-full`}
              >
                Book your stay
              </a>
            </div>
          ...
          <div className="text-lg lg:text-xl">
            ...
            <div className="mt-4 flex flex-col gap-6">
              ...
              <p>
                ...
                other attendees in the lobby and other areas of the hotel as
                late as you please.
              </p>
              <p>
                The hotel is also within walking distance to food, drink, and
                fun.{" "}
