...
export async function advancedGuidesHandler({ render, request }: AppContext) {
  return render(
    <AdvancedGuidesPage requestUrl={request.url} />,
    docsResponseInit,
  );
}
...
function AdvancedGuidesPage(handle: Handle<DocsPageProps>) {
  return () => (
    ...
    >
      <DocsSection
        id="building-custom-ui-primitives"
        title="Building custom UI primitives"
      >
        <p>Placeholder for Building custom UI primitives.</p>
      </DocsSection>

      <DocsSection
        id="building-reusable-mixin-libraries"
        title="Building reusable mixin libraries"
      >
        <p>Placeholder for Building reusable mixin libraries.</p>
      </DocsSection>

      <DocsSection
        id="low-level-route-patterns"
        title="Low-level route patterns"
      >
      ...
      <DocsSection
        id="building-clis-with-remix-packages"
        title="Building CLIs with Remix packages"
      >
        <p>Placeholder for Building CLIs with Remix packages.</p>
      </DocsSection>

      <DocsSection
        id="integrating-external-services"
