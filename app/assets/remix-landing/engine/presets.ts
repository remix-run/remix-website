...
const drive: Preset = {
  ...
  controls: [
    ...
    { id: "wheelThick", label: "Wheel Thickness", min: 0.02, max: 0.5, initial: 0.18 },
    { id: "wheelbase", label: "Wheelbase (F/R)", min: 0.2, max: 2.0, initial: 1.14 },
    { id: "wheelTrack", label: "Wheel Track (L/R)", min: 0.2, max: 2.0, initial: 0.68 },
    { id: "wheelY", label: "Wheel Y Position", min: -1.0, max: 0.5, initial: -0.13 },
    { id: "wheelZ", label: "Wheel Z Offset", min: -0.5, max: 0.5, initial: -0.11 },
    { id: "_carPosY", label: "Car Y Position", min: -15, max: 15, initial: -3.15 },
  ],
...
export const presets: Preset[] = [racetrack, racecar, runner, underTheHood, websiteMockups, drive];
