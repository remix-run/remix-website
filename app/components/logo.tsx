    ...
    >
      <g filter="url(#filter0_dd)">
        <path
          fill="#E8F2FF"
          fillRule="evenodd"
          d="M279.357 254.236c1.801 23.108 1.801 33.94 1.801 45.764h-53.531c0-2.576.046-4.932.092-7.321.145-7.426.296-15.171-.908-30.811-1.593-22.897-11.465-27.985-29.617-27.985H113v-41.659h86.741c22.93 0 34.394-6.967 34.394-25.412 0-16.218-11.464-26.047-34.394-26.047H113V100h96.295c51.91 0 77.705 24.487 77.705 63.602 0 29.258-18.152 48.338-42.674 51.518 20.7 4.135 32.802 15.901 35.031 39.116z"
          clipRule="evenodd"
        ></path>
        <path
          stroke="#3992FF"
          strokeOpacity="0.8"
          d="M279.855 254.197v-.009c-1.123-11.686-4.736-20.544-10.72-27.005-5.472-5.907-12.889-9.769-22.088-11.977 23.422-4.209 40.453-23.168 40.453-51.604 0-19.673-6.492-35.725-19.562-46.85-13.059-11.114-32.617-17.252-58.643-17.252H112.5v41.765h87.241c11.404 0 19.876 2.446 25.488 6.836 5.592 4.375 8.406 10.731 8.406 18.711 0 9.11-2.823 15.286-8.387 19.214-5.603 3.956-14.072 5.698-25.507 5.698H112.5v42.659h84.694c9.052 0 15.903 1.275 20.697 5.29 4.782 4.005 7.628 10.835 8.421 22.23v.004c1.203 15.615 1.052 23.343.907 30.759v.006c-.046 2.387-.092 4.748-.092 7.328v.5h54.531v-.5c0-11.832 0-22.678-1.803-45.803z"
        ></path>
        <path
          fill="#E8F2FF"
          d="M113 300v-31.056h56.602c9.454 0 11.507 7.004 11.507 11.18V300H113z"
        ></path>
        <path
          stroke="#3992FF"
          strokeOpacity="0.8"
          d="M112.5 300v.5h69.109v-20.376c0-2.155-.527-5.068-2.307-7.455-1.8-2.412-4.832-4.225-9.7-4.225H112.5V300z"
        ></path>
      </g>
      <defs>
        <filter
