...
function TutorialsPage(handle: Handle<DocsPageProps>) {
  return () => (
    ...
    >
      <DocsSection
        id="build-your-first-remix-app"
        title="Build your first Remix app"
      >
      ...
      <DocsSection
        id="build-authenticated-routes"
        title="Build authenticated routes"
      >
        <p>Placeholder for Build authenticated routes.</p>
      </DocsSection>

      <DocsSection
        id="build-a-file-upload-flow"
        title="Build a file upload flow"
      >
      ...
      <DocsSection
        id="build-a-frame-powered-dashboard"
        title="Build a frame-powered dashboard"
      >
        <p>Placeholder for Build a frame-powered dashboard.</p>
      </DocsSection>

      <DocsSection
        id="build-a-data-backed-admin-area"
        title="Build a data-backed admin area"
      >
      ...
      <DocsSection
        id="build-a-small-app-from-scratch"
