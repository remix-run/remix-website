...
Hope you enjoy it! If not, we will be supporting tailwind by default (we don't yet) and you can use any CSS-in-JS solution you want. Again, refer to the <Link to="/docs/styling">Styling Guide</Link> for details.
