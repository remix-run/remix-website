...
import styles from "url:../../styles/routes/dashboard/docs.css";
...
type Section = [string, Page[]];
type Page = [string, string, { new?: boolean; disabled?: boolean }?];
...
let sections: Section[] = [
  ...
  [
    ...
    [
      ["Remix Config", "config"],
      ["Conventions", "conventions", { new: true }],
