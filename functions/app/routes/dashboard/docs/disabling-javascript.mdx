---
meta:
  title: Disabling JavaScript | Remix Tutorial
---
...
## Editing root.tsx to Disable JavaScript

In the near future we'll have a more built in way to do this, but this works pretty well already. Edit your `root.tsx` file (or whichever file you render the `<Scripts/>` tag in) and add something like this:

```jsx
import React from "react";
import { Meta, Scripts, Links, Routes } from "@remix-run/react";
