...
Go ahead and add a `routes/gists.css` and `routes/gists/$user.css` and add whatever styles you want. When you're done, open the dev tools and watch the `<head>` component as you navigate around. You'll see the styles loading and unloading per route.
