...
This project uses TypeScript, we encourage you to learn it if you haven't tried it yet. We keep the types very basic. If you really don't want to use TypeScript, just rename the files from `.ts` and `.tsx` to `.js` and remove the types.
